                        ...
                        <li class="nav-item dropdown dropdown-center user-dropdown">
                            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown"
                                ...
                                <img class="img-xs rounded-circle"
                                    src="{{ asset('admin/assets/images/avatar-default.svg') }}" alt="Profile image" />
                            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" href="{{ route('users.index') }}" role="button"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('topics.index') }}" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            TOPICS
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('categories.index') }}" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            CATEGORIES
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('testmonials.index') }}" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            TESTIMONIALS
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('testmonials.create') }}">Add testimonial</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
                            <li><a class="dropdown-item" href="{{ route('testmonials.index') }}">All testimonials</a>
                            </li>
                        </ul>
                    </li>
